function [Y,U,t_total,t_update,Xobs] = forwardIntegrate(i)
...
% Created: 31 Oct 2021
    ...
    Xobs = generateRandomObstacles(25,TestTrack);
    ...
    while t_total < TOTAL_TIME 
        ...
        [Utemp, FLAG_terminate] = ROB535_ControlProject_part2_Team2_modified(TestTrack,Xobs_seen,curr_state); 
